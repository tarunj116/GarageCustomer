...
export function Category2detail2({navigation}) {
...
/>
<Text style={{color:"#3F51B5",fontSize:14,fontFamily:"NexaLight",marginTop:10}}>CAR SERVICES:</Text>
<ScrollView style={styles.list}>
      ...
      <FlatList 
          ...
          renderItem={(post) => {
            ...
            return (
              <TouchableOpacity onPress={() => { navigation.navigate('Category2detail3')    ;}} style={styles.card}> 
              <View >
