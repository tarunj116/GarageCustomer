...
export function Category9({navigation}) {
  ...
  return (
    ...
    <Text style={{left:"7%",fontSize:16,color:"white",fontFamily:"NexaLight"}}>
        ...
        <View style={styles.middle}>
          ...
          <Image 
        source={require('../../assets/inter1.png')}
        style={{
            width:50,
            height:50,
            marginLeft:25,
    ...
    />
            <Text style={{marginLeft:20,marginTop:"3%",color:"#3F51B5",fontSize:17,fontFamily:"NexaLight"}}>CAR INTERIOR CLEANING</Text>
          </View>
          </View>
...
<TouchableOpacity
      ...
      onPress={() => {
        navigation.navigate('Category9first');
      }}>
