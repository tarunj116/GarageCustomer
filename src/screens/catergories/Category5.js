...
export function Category5({navigation}) {
  ...
  return (
    ...
    <Text style={{left:"7%",fontSize:16,color:"white",fontFamily:"NexaLight"}}>
          ...
          <FlatList 
           ...
           showsHorizontalScrollIndicator={false}
                data={[
                  ...
                  {key: 'Motors',color:'#7A8BE5',image:require('../../assets/motors.png'),redirect:"Category5"},
        ...
        <View style={styles.middle}>
          ...
          <Image 
        source={require('../../assets/motors.png')}
        style={{
            width:90,
            height:40,
            marginLeft:15,
    ...
    />
            <Text style={{marginLeft:20,marginTop:"3%",color:"#3F51B5",fontSize:19,fontFamily:"NexaLight"}}>MOTORCYCLES</Text>
          </View>
          </View>
...
<RadioButton.Group onValueChange={newValue => setValue(newValue)} value={value}>
      <View style={{flexDirection:"row",backgroundColor:"#CFD7FF",borderRadius:20,padding:10}}>
        ...
        <Text style={{marginLeft:10,marginTop:4,fontSize:20,fontFamily:"NexaLight",color:"#636363"}}>Yamaha</Text>
      </View>
      <View style={{marginTop:10,flexDirection:"row",backgroundColor:"#F1F1F1",borderRadius:20,padding:10}}>
        ...
        <Text style={{marginLeft:10,marginTop:4,fontSize:20,fontFamily:"NexaLight",color:"#636363"}}>Kawasaki</Text>
      </View>
      <View style={{marginTop:10,flexDirection:"row",backgroundColor:"#F1F1F1",borderRadius:20,padding:10}}>
        
        <RadioButton color={'#3F51B5'} value="third" />
        <Text style={{marginLeft:10,marginTop:4,fontSize:20,fontFamily:"NexaLight",color:"#636363"}}>Triumph</Text>
      </View>
      <View style={{marginTop:10,flexDirection:"row",backgroundColor:"#F1F1F1",borderRadius:20,padding:10}}>
        
        <RadioButton color={'#3F51B5'} value="fouth" />
        <Text style={{marginLeft:10,marginTop:4,fontSize:20,fontFamily:"NexaLight",color:"#636363"}}>Ducati</Text>
      </View>
      <View style={{marginTop:10,flexDirection:"row",backgroundColor:"#F1F1F1",borderRadius:20,padding:10}}>
        
        <RadioButton color={'#3F51B5'} value="fouth" />
        <Text style={{marginLeft:10,marginTop:4,fontSize:20,fontFamily:"NexaLight",color:"#636363"}}>Harley-Davidson</Text>
      </View>
    </RadioButton.Group>
...
<TouchableOpacity
      ...
      onPress={() => {
        navigation.navigate('Category5first');
      }}>
