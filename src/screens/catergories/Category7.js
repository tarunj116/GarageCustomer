...
export function Category7({navigation}) {
...
<TouchableOpacity  onPress={() => navigation.navigate('Category7first')} style={{height:80,width:"60%",marginTop:30,flexDirection:"row",backgroundColor:"#576CE4",borderTopLeftRadius:20,borderTopRightRadius:20,borderBottomLeftRadius:20,borderBottomRightRadius:20,alignSelf:"center", shadowColor: '#000',shadowOffset: { width: 1, height: 1 },shadowOpacity:  0.4,shadowRadius: 3,elevation: 5}}>
    ...
    />
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Category7first')} style={{height:80,width:"60%",marginTop:30,flexDirection:"row",backgroundColor:"#FFFFFF",borderTopLeftRadius:20,borderTopRightRadius:20,borderBottomLeftRadius:20,borderBottomRightRadius:20,alignSelf:"center", shadowColor: '#000',shadowOffset: { width: 1, height: 1 },shadowOpacity:  0.4,shadowRadius: 3,elevation: 5}}>
          <Image 
    ...
    />
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Category7first')} style={{marginBottom:50,height:80,width:"60%",marginTop:30,flexDirection:"row",backgroundColor:"#FFFFFF",borderTopLeftRadius:20,borderTopRightRadius:20,borderBottomLeftRadius:20,borderBottomRightRadius:20,alignSelf:"center", shadowColor: '#000',shadowOffset: { width: 1, height: 1 },shadowOpacity:  0.4,shadowRadius: 3,elevation: 5}}>
          <Image 
