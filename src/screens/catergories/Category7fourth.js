...
export function Category7fourth({navigation}) {
          ...
          <FlatList 
           ...
           showsHorizontalScrollIndicator={false}
                data={[
                  ...
                  {key: 'Vehicle Wash',color:'#7A8BE5',image:require('../../assets/wash.png'),redirect:"Category7"},
...
/>
<View style={{marginTop:10,padding:20,borderRadius:10,backgroundColor:"#EBEBEB"}}>
...
<TouchableOpacity
      ...
      onPress={() => {
        navigation.navigate('Category7first');
      }}>
