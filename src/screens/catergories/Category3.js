...
export function Category3({navigation}) {
  ...
  return (
    ...
    <Text style={{left:"7%",fontSize:16,color:"white",fontFamily:"NexaLight"}}>
        ...
        <View style={styles.middle}>
          ...
          <Image 
        source={require('../../assets/spare.png')}
        style={{
            width:90,
            height:40,
            marginLeft:15,
    ...
    />
            <Text style={{marginLeft:20,marginTop:"3%",color:"#3F51B5",fontSize:19,fontFamily:"NexaLight"}}>SPARE PARTS</Text>
          </View>
          </View>
...
<TouchableOpacity  onPress={() => navigation.navigate('Category3first')} style={{height:80,width:"60%",marginTop:30,flexDirection:"row",backgroundColor:"#576CE4",borderTopLeftRadius:20,borderTopRightRadius:20,borderBottomLeftRadius:20,borderBottomRightRadius:20,alignSelf:"center", shadowColor: '#000',shadowOffset: { width: 1, height: 1 },shadowOpacity:  0.4,shadowRadius: 3,elevation: 5}}>
    ...
    />
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Category3first')} style={{height:80,width:"60%",marginTop:30,flexDirection:"row",backgroundColor:"#FFFFFF",borderTopLeftRadius:20,borderTopRightRadius:20,borderBottomLeftRadius:20,borderBottomRightRadius:20,alignSelf:"center", shadowColor: '#000',shadowOffset: { width: 1, height: 1 },shadowOpacity:  0.4,shadowRadius: 3,elevation: 5}}>
          <Image 
    ...
    />
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Category3first')} style={{marginBottom:50,height:80,width:"60%",marginTop:30,flexDirection:"row",backgroundColor:"#FFFFFF",borderTopLeftRadius:20,borderTopRightRadius:20,borderBottomLeftRadius:20,borderBottomRightRadius:20,alignSelf:"center", shadowColor: '#000',shadowOffset: { width: 1, height: 1 },shadowOpacity:  0.4,shadowRadius: 3,elevation: 5}}>
          <Image 
