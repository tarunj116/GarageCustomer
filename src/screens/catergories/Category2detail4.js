...
export function Category2detail4({navigation}) {
...
<View>
  ...
  <View  style={{flexDirection:"row",alignItems:"center"}}>
    ...
    <Text style={{color:"#3F51B5",fontSize:15,fontFamily:"NexaLight"}}>{`Transmission Repair`}</Text>
    <Text style={{color:"#CFD7FF",fontSize:12,fontFamily:"NexaLight"}}>{`AED 150`}</Text>
