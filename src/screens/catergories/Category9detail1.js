...
export function Category9detail1({navigation}) {
...
<View  style={{flexDirection:"row",alignItems:"center"}}>
    ...
    <Text style={{color:"#3F51B5",fontSize:15,fontFamily:"NexaLight"}}>{`Vacuum cleaning`}</Text>
...
<TouchableOpacity
      ...
      onPress={() => {
        navigation.navigate('Category9detail2');
      }}>
