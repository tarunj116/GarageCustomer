...
export function Category4detail({navigation}) {
    ...
    <Text style={{left:"7%",fontSize:16,color:"white",fontFamily:"NexaLight"}}>
        ...
        <View style={styles.middle}>
          ...
          <View style={{flex:1,alignContent:"center",backgroundColor:"#CFD7FF",borderTopLeftRadius:50,borderTopRightRadius:50,borderBottomLeftRadius:50,alignItems:"center"}}>
            ...
            <Text style={{marginLeft:50,marginTop:20,color:"#3F51B5",fontSize:21,fontFamily:"NexaLight"}}>TIRE SERVICE</Text>
          </View>
          </View>
...
/>
<ScrollView>
<TouchableOpacity onPress={() => {navigation.navigate('Category4detail1');}}  style={{flexDirection:"row",alignItems:"center",margin:10,borderRadius:10,backgroundColor:"#F1F1F1"}}>
<TouchableOpacity><ImageBackground 
    ...
    ><Image style = {{height:25,width:25,marginTop:5,marginLeft:5}} source = {require('../../assets/love.png')} /></ImageBackground></TouchableOpacity>
    <View style={{margin:10}}>
    <Text style={{color:"#3F51B5",fontSize:15,fontFamily:"NexaLight"}}>{`Tire Checkup`}</Text>
    <Text style={{color:"#3F51B5",fontSize:12,fontFamily:"NexaLight"}}>{`Sold by: Garage Name`}</Text>
    <Text style={{color:"#3F51B5",marginLeft:55,fontSize:12,fontFamily:"NexaLight"}}>{`Barsha, Dubai`}</Text>
