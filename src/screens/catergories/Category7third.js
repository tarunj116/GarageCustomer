...
export function Category7third({navigation}) {
...
/>
<Text style={{color:"#3F51B5",fontFamily:"NexaLight",alignSelf:"center",marginBottom:20,marginTop:20,fontSize:23}}>Wash Location:</Text>
<Text style={{color:"#3F51B5",fontFamily:"NexaLight"}}>Indoor / House Carwash:</Text>
<View
        style={{
          color: '#fff',
          backgroundColor:'white',
        ...
        <TextInput
        style={styles.input}
        placeholder="Al Kifaf, ADCB, Dubai"
      ...
      onPress={() => {
        navigation.navigate('Category7fourth');
      }}>
