...
export function Category9detail2({navigation}) {
    ...
    <Text style={{left:"7%",fontSize:16,color:"white",fontFamily:"NexaLight"}}>
        ...
        <ScrollView style={styles.middle}>
          ...
          <View style={{flex:1,alignContent:"center",backgroundColor:"#CFD7FF",borderTopLeftRadius:50,borderTopRightRadius:50,borderBottomLeftRadius:50,alignItems:"center"}}>
            ...
            <Text style={{marginLeft:50,marginTop:20,color:"#3F51B5",fontSize:17,fontFamily:"NexaLight"}}>CAR INTERIOR CLEANING</Text>
          </View>
          </View>
...
<View>
  ...
  <View  style={{flexDirection:"row",alignItems:"center"}}>
    ...
    <Text style={{color:"#3F51B5",fontSize:15,fontFamily:"NexaLight"}}>{`Full interior Clean`}</Text>
    <Text style={{color:"#CFD7FF",fontSize:12,fontFamily:"NexaLight"}}>{`Vacuum cleaning`}</Text>
    <Text style={{color:"#3F51B5",fontSize:12,fontFamily:"NexaLight"}}>{`AED 120`}</Text>
