...
export function Category8detail({navigation}) {
    ...
    <Text style={{left:"7%",fontSize:16,color:"white",fontFamily:"NexaLight"}}>
        ...
        <View style={styles.middle}>
          ...
          <View style={{flex:1,alignContent:"center",backgroundColor:"#CFD7FF",borderTopLeftRadius:50,borderTopRightRadius:50,borderBottomLeftRadius:50,alignItems:"center"}}>
            ...
            <Text style={{marginLeft:50,marginTop:20,color:"#3F51B5",fontSize:21,fontFamily:"NexaLight"}}>CAR ACCESSORIES</Text>
          </View>
          </View>
...
<Text style={{marginLeft:100,color:"#636363",fontSize:15,fontFamily:"NexaBold",marginTop:13,marginBottom:10}}>Tesla - Model X</Text>
...
/>
<ScrollView>
<TouchableOpacity onPress={() => {navigation.navigate('Category8');}}  style={{flexDirection:"row",alignItems:"center",margin:10,borderRadius:10,backgroundColor:"#F1F1F1"}}>
    ...
    <Text style={{color:"#3F51B5",fontSize:15,fontFamily:"NexaLight"}}>{`Car seat accessory`}</Text>
    <Text style={{color:"#3F51B5",fontSize:15,fontFamily:"NexaLight"}}>{`Sold by: Garage Name`}</Text>
    ...
    /></TouchableOpacity>
    <View style={{margin:20}}>
    <Text style={{color:"#3F51B5",fontSize:15,fontFamily:"NexaLight"}}>{`Interior Furry Covers`}</Text>
    <Text style={{color:"#3F51B5",fontSize:15,fontFamily:"NexaLight"}}>{`Sold by: Garage Name`}</Text>
    <Text style={{color:"#3F51B5",fontSize:12,fontFamily:"NexaLight"}}>{`PRICE: AED 80`}</Text>
    ...
    /></TouchableOpacity>
    <View style={{margin:20}}>
    <Text style={{color:"#3F51B5",fontSize:15,fontFamily:"NexaLight"}}>{`LED neon lights`}</Text>
