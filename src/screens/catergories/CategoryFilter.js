...
export function CategoryFilter({navigation}) {
  ...
  return (
    ...
    <Text style={{left:"7%",fontSize:16,color:"white",fontFamily:"NexaLight"}}>
          ...
          <FlatList 
           ...
           showsHorizontalScrollIndicator={false}
                data={[
                  {key: 'Car Maintenance',color:'#7A8BE5',image:require('../../assets/car_picture3x.png'),redirect:"Category1"},
    ...
    <View style={{width:"90%"}}>
    <View style={{flexDirection:"row"}}>
            <Text style={{color:"#3F51B5",fontFamily:"NexaLight",fontSize:15,marginBottom:10,marginTop:10}}>Car model:</Text>
            <Text style={{color:"#3F51B5",fontFamily:"NexaLight",fontSize:15,marginLeft:140,marginBottom:10,marginTop:10}}>Tesla</Text>
            </View>
<View
  style={{
