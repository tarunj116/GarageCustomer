...
export function Category3first({navigation}) {
  ...
  return (
    ...
    <Text style={{left:"7%",fontSize:16,color:"white",fontFamily:"NexaLight"}}>
        ...
        <TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Category3Filter')}>
          <Image
      ...
      <FlatList 
          ...
          renderItem={(post) => {
            ...
            return (
              <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Category3detail')}> 
              <View >
