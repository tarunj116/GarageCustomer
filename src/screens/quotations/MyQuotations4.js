...
export function MyQuotations4({navigation}) {
...
<Text style={{marginLeft:90,color:"#636363",fontFamily:"NexaBold",marginBottom:10}}>45 available points</Text>
</View>
<Text style={{marginLeft:200,color:"#636363",fontFamily:"NexaBold",marginBottom:10}}>= AED 9.00 Discount</Text>
<Text style={{marginLeft:200,color:"#3F51B5",fontFamily:"NexaBold",marginBottom:10,textDecorationLine:"underline"}}>USE POINTS</Text>
<View
  style={{
    borderBottomColor: '#3F51B5',
    borderBottomWidth: 1.5,
...
<TouchableOpacity
      ...
      onPress={() => {
        navigation.navigate('MyQuotations5');
      }}>
