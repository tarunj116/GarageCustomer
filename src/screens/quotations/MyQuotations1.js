...
export function MyQuotations1({navigation}) {
...
<TouchableOpacity
      ...
      <Text style={{ color: '#FFFFFF',fontFamily:"NexaLight",fontSize: 17}}>MY QUOTES</Text>
    </TouchableOpacity>
    <TouchableOpacity
      style={[styles.container1, {backgroundColor: '#3F51B5',marginTop:"2%",left:2}]}
      onPress={() => {
        navigation.navigate('MyQuotations1');
      }}>
      <Text style={{ color: '#CFD7FF',fontFamily:"NexaLight",fontSize: 17}}>PURCHASED</Text>
    </TouchableOpacity>
</View>
<TouchableOpacity onPress={() => {navigation.navigate('MyQuotations6');}}  style={{flexDirection:"row",alignItems:"center",margin:10,borderRadius:10,backgroundColor:"#FFFFFF",shadowColor: '#000',
  ...
  elevation: 5,
   marginVertical: 7}}>
    ...
    <Text style={{color:"#3F51B5",fontSize:15,fontFamily:"NexaLight"}}>{`Benny's Auto Garage`}</Text>
    ...
    <Text style={{color:"#3F51B5",fontSize:12,fontFamily:"NexaLight"}}>{`Total: `}<Text style={{color:"#636363",fontSize:12,fontFamily:"NexaBold"}}>AED 44.00</Text></Text>
