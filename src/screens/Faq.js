  ...
  return (
    ...
    <TouchableOpacity onPress={navigation.openDrawer}>
      <Image
          ...
          /></TouchableOpacity>
           <Text style={{marginLeft:180,marginTop:20,alignSelf:"center",color:"white",fontSize:25,fontFamily:"NexaBold"}}>FAQ</Text>
        </View>
        <View style={styles.middle}>
           ...
           <View
          style={{marginTop:150,flex:0.94,margin:10,borderRadius:20,margin:10,backgroundColor:"white"}}
         >
