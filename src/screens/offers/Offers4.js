...
export function Offers4({navigation}) {
  ...
  return (
    ...
    <View><Text style={{color:"#3F51B5",alignSelf:"center",fontFamily:"NexaLight",marginTop:10,fontSize:18}}>20% OFFER ON NEW REGISTERS</Text>
    <View
  style={{
    ...
    <TouchableOpacity
      ...
      <FlatList 
          ...
          renderItem={(post) => {
            ...
            return (
              <TouchableOpacity style={styles.card} onPress={() => { navigation.navigate('Offers5', { garage_id: "61360b59bce17e10c3516b7f", service_id: "615aef0176fcf2721bfe9640", spare_id: "615ae2f15509c451ad756f6a" })    ;}}> 
              <View >
