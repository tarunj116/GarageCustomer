...
<TouchableOpacity onPress={() => {
        navigation.navigate('MyPurchases3');
      }}  style={{height:100,width:"96%",marginTop:30,backgroundColor:"white",borderTopLeftRadius:20,borderTopRightRadius:20,borderBottomLeftRadius:20,borderBottomRightRadius:20,alignSelf:"center", shadowColor: '#000',shadowOffset: { width: 1, height: 1 },shadowOpacity:  0.4,shadowRadius: 3,elevation: 5}}>
           <View style={{flexDirection:'row'}}>
           
            <Text style={{marginLeft:20,marginTop:10,color:"#3F51B5",fontSize:14,fontFamily:"NexaBold"}}>QUOTE#1123562</Text>
            <Text style={{marginLeft:45,marginTop:10,color:"#636363",fontSize:14,fontFamily:"NexaBold"}}>March 3, 2021</Text>
            </View>
            <View style={{flexDirection:'row'}}>
            <Image 
        source={require('../../assets/circleimg.png')}
        style={{
    ...
    />
     <Text style={{marginTop:10,color:"#636363",fontSize:14,fontFamily:"NexaBold"}}>ADCB Garage</Text>
    </View>
            <Text style={{marginLeft:20,marginTop:-10,color:"#3F51B5",fontSize:14,fontFamily:"NexaBold"}}>AED 355.75</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => {
        navigation.navigate('MyPurchases3');
      }}  style={{height:100,width:"96%",marginTop:30,backgroundColor:"white",borderTopLeftRadius:20,borderTopRightRadius:20,borderBottomLeftRadius:20,borderBottomRightRadius:20,alignSelf:"center", shadowColor: '#000',shadowOffset: { width: 1, height: 1 },shadowOpacity:  0.4,shadowRadius: 3,elevation: 5}}>
