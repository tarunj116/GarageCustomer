...
export function Homedetail7({navigation}) {
...
/>
<Text style={{margin:10,color:"#3F51B5",fontSize:16,fontFamily:"NexaLight"}}>Selected Services:</Text>
<View style={{flexDirection:"row",backgroundColor:"#F1F1F1",borderRadius:20,padding:10,margin:10}}>
        
       
        <Text style={{marginLeft:10,marginTop:4,fontSize:15,fontFamily:"NexaBold",color:"#636363"}}>1. Car tire alignment</Text>
      </View>
<View
  style={{
    borderBottomColor: '#CFD7FF',
...
<TouchableOpacity
      ...
      onPress={() => {
        navigation.navigate('Homedetail8');
      }}>
