...
export function Homedetail1({navigation}) {
...
<TouchableOpacity
      onPress={() => {
        navigation.navigate('Homedetail2');
      }}>
<Text style={{color:"#3F51B5",fontSize:10,fontFamily:"NexaBold",textDecorationLine: 'underline',alignSelf:"flex-end",marginRight:10,marginTop:10}}>VIEW ALL</Text></TouchableOpacity>
...
<Text style={{color:"#3F51B5",fontFamily:"NexaLight",marginTop:10,margin:10}}>Supported vehicle models:</Text>
...
/>
<Text style={{color:"#3F51B5",fontFamily:"NexaLight",marginBottom:10,marginTop:10,margin:10}}>Spare parts:</Text>
<Text style={{color:"#3F51B5",fontSize:10,fontFamily:"NexaBold",textDecorationLine: 'underline',alignSelf:"flex-end",marginRight:10}}>VIEW ALL</Text>
<ScrollView style={styles.list}>
      <FlatList 
          contentContainerStyle={styles.listContainer}
          showsVerticalScrollIndicator={false}
          data={[
            {id:1, title: "Battery",image:require('../../assets/sidebar1.png')},
            {id:2, title: "Brakes",image:require('../../assets/sidebar2.png')} ,
            {id:3, title: "Axle",image:require('../../assets/sidebar3.png')}, 
            {id:4, title: "Fuel Injector",image:require('../../assets/sidebar4.png')}, 
            {id:5, title: "Piston",image:require('../../assets/sidebar5.png')}, 
            {id:6, title: "A/C Compressor",image:require('../../assets/sidebar6.png')}, 
