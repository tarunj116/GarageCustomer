...
export default class Homedetail extends Component {
      ...
      .then((response) => {
        ...
        if (response.data.success == true) {
          ...
          if (response.data.data[0].ratings.length > 0) {
            var arrayRating = response.data.data[0].ratings;
          } else {
  ...
  getRatingList(){
    ...
    const url = `${BASE_URL}/customer/rating_list`;
    const params = JSON.stringify({
      "garage_id": this.props.route.params.garage_id,
    });
    axios.post(url, params, {
      ...
      .then((response) => {
        ...
        this.setState({ ratingArr: response.data.data });
  ...
  removeImage = (id,index)=> {
    console.log(id);
    if(id == 'photo'){
      const itemsnew = [...this.state.photos_videos_rat];
      itemsnew.splice(index, 1);
      console.log(itemsnew);
      this.setState({ photos_videos_rat: itemsnew });
    }
   
     }
     addReview() {
      const { navigate } = this.props.navigation;
        const url = `${BASE_URL}/customer/submit_rating`;
        ...
        //this.setState({ isModalFirstVisible: false });
        //return false;
        var userNewId = this.state.userNewId.replace('"','');
        userNewId = userNewId.replace('"','');
        const params ={
    ...
    const handleChoosePhotoVideo = () => {
      ...
      ImagePicker.launchImageLibrary(options, (response) => {
        ...
        if(response.didCancel == true){
          ...
          let imageValueData = this.state.photos_videos_rat;
          imageValueData.push(imageDataVideo);
         
           this.setState({photos_videos_rat : imageValueData})
        }
            ...
            <View style={{ margin: 5 }}>
              ...
              <View style={{ flexDirection: "row", width: "30%" }}>
                ...
                <TouchableOpacity onPress={() => {
                  ...
                  <Text style={{ marginLeft: 20, color: "#3F51B5", fontSize: 8, fontFamily: "NexaBold", textDecorationLine: 'underline' }}>VIEW RATING</Text></TouchableOpacity>
              </View>
            </View>
  ...
  <TouchableOpacity
      ...
      <TouchableOpacity
        ...
        <View style={styles.footer}>
                ...
                <View style={{ backgroundColor: "white", borderRadius: 24 }}>
                  <View style={{ backgroundColor: "#CFD7FF", borderTopLeftRadius: 30, borderTopRightRadius: 30, borderBottomLeftRadius: 30 }}>
                    <View style={{ flexDirection: "row", marginBottom: 30 }}>
                      ...
                      />
                      <Text style={{ alignSelf: "center", marginLeft: 10, fontSize: 18, color: "#3F51B5", fontFamily: "NexaLight", marginTop: 10 }}>Ratings and Reviews</Text>
                  ...
                  <View style={{ marginTop: 50, backgroundColor: "white", borderTopRightRadius: 30 }}>
                    <FlatList
                      data={this.state.ratingArr}
                      ...
                      renderItem={({ item, index }) => {
                        ...
                        return (
                          <View style={{
                            width: "90%", marginBottom: 30, marginLeft: "5%", flexDirection: "row", alignItems: "center", backgroundColor: "white", borderRadius: 20, shadowColor: '#000',
                            shadowOffset: { width: 1, height: 1 },
                            shadowOpacity: 0.4,
                            shadowRadius: 3,
                            elevation: 5,
                            ...
                            <TouchableOpacity>
                              <Image
                              source={{uri:item.customer_detail[0].profile_image}}
                              style={{
                                width: 60,
                                height: 60,
                                marginTop: -60,
                            ...
                            <View style={{ margin: 10 }}>
                              <Text style={{ color: "#3F51B5", fontSize: 14, fontFamily: "NexaLight" }}>
                                {item.customer_detail[0].name}
                                </Text>
                      ...
                      >{item.rating} Stars</Text>
                                <Text style={{ color: "#3F51B5", fontSize: 10, fontFamily: "NexaLight"}}>{moment(item.createdAt).format('DD-MM-YYYY')}</Text>
                              </TouchableOpacity>
                              <Text style={{ width: 200, color: "#CFD7FF", fontSize: 8, fontFamily: "NexaLight", justifyContent: "center" }}>{item.review}</Text>
                            </View>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        this.setState({ isModalFirstVisible: true });
                      }}
                    >
          ...
          <View style={{ flex: 1 }}>
            {/* this.state.isModalFirstVisible */}
            ...
            <FlatList
                ...
                data={this.state.photos_videos_rat}
                // style={{ flex: 1, margin:"5%"}}
